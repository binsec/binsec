...
let lt4, et4 =
  ...
  let t4 = Dba.Var.create "%%0" ~bitsize ~tag:Dba.VarTag.Temp in
  (L.v t4, E.v t4)

let lt8, et8 =
  let t8 = Dba.Var.create "%%0" ~bitsize:Size.Bit.bits8 ~tag:Dba.VarTag.Temp in
  (L.v t8, E.v t8)

let lt16, et16 =
  let t16 =
    Dba.Var.create "%%0" ~bitsize:Size.Bit.bits16 ~tag:Dba.VarTag.Temp
  in
  (L.v t16, E.v t16)
