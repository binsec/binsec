...
(** This module aim at generating well formatted smtlib2 formulas, taking in
    account some solvers differences (e.g: boolector not supporting function
...
(** @return the string formatting every input variable on a new line *)
