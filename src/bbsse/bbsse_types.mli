...
module Path_state : sig
  ...
  val counter : Virtual_address.t -> t -> Bbsse_options.Address_counter.t option

  (** {2 Modifiers} *)

  val set_counter :
    Virtual_address.t -> Bbsse_options.Address_counter.t -> t -> t
  ...
  val set_address_counters :
    Bbsse_options.Address_counter.t Virtual_address.Map.t -> t -> t
